<template>
  <div class="sis_event-admin">
        ...
        <b-row>
          <b-col md="12">
            <b-form-group
              label="Evento:"
              class="search_input"
              :hidden="search_input_hide"
              label-for="sis_event-name"
            >
    ...
    <b-row>
      ...
      <b-col md="6">
        <b-form-group label="Filtrar por tabelas">
          <FormTagSearch
            @loadInput="chargeTagTabelas"
            :value="valueTabelas"
            :options="optionsTabelas"
          />
        </b-form-group>
      </b-col>
    </b-row>
    <b-input-group size="md" class="mt-3 mb-3">
      <b-form-input
        type="text"
        placeholder="Digite aqui para filtrar um evento..."
  ...
  data: function () {
    return {
      ...
      fields: [
        ...
        { key: "id_registro", label: "ID", sortable: true },
        {
          key: "created_at",
          label: "Data",
          sortable: true,
