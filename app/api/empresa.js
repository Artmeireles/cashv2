...
module.exports = app => {
    ...
    const save = async (req, res) => {
        ...
        if (contentType == "text/plain") {
            ...
            body = {}
            body.cliente = bodyRaw.cliente
            body.dominio = bodyRaw.dominio
            body.nr_insc = bodyRaw.nrInsc_14
            body.cnpj_efr = bodyRaw.cnpjEFR_45 || bodyRaw.cnpjEFR_70
            body.id_param_cl_trib = await getIdParam('classTrib', bodyRaw.classTrib_16)
            body.ind_opt_reg_eletron = bodyRaw.indOptRegEletron_21
            body.razao_social = bodyRaw.razao_social
            body.id_cidade = await getIdCidade(bodyRaw.municipio_id)
