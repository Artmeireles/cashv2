exports.up = function(knex) {
    return knex.schema.createTable('wwmgca_maribondo_ativos.serv_desligamentos', table => {
        table.engine('InnoDB')
...
exports.down = function(knex) {
    return knex.schema.dropTable('wwmgca_maribondo_ativos.serv_desligamentos')
};