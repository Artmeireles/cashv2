exports.up = function(knex) {
    return knex.schema.createTable('wwmgca_cliente_ativos.es_envios', table => {
        table.engine('InnoDB')
        ...
        table.string('es_evento', 255).notNull().comment("eSocial Evento")
...
exports.down = function(knex) {
    return knex.schema.dropTable('wwmgca_cliente_ativos.es_envios')
};