...
exports.up = function (knex) {
    return knex.schema.createTable('wwmgca_cliente_ativos.siafic_desapropriacao', table => {
        table.engine('InnoDB')
...
exports.down = function (knex) {
    return knex.schema.dropTable('wwmgca_cliente_ativos.siafic_desapropriacao')
};
