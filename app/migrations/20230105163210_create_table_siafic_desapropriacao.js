...
exports.up = function(knex) {
    return knex.schema.createTable(migrationClientSchema + '.siafic_desapropriacao', table => {
        table.engine('InnoDB')
...
exports.down = function (knex) {
    return knex.schema.dropTable(migrationClientSchema + '.siafic_desapropriacao')
};
