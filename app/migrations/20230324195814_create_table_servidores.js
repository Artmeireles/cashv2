exports.up = function(knex) {
    return knex.schema.createTable('wwmgca_maribondo_ativos.servidores', table => {
        table.engine('InnoDB')
        ...
        table.string('dsc_lograd', 100).notNull().comment("Descrição do Logradouro")
...
exports.down = function(knex) {
    return knex.schema.dropTable('wwmgca_maribondo_ativos.servidores')
};