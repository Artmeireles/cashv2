...
module.exports = app => {
    ...
    */
    ...
    // app.route('/cad-convenios/:id')
    //     .all(app.config.passport.authenticate())
    //     .put(app.api.cadBConvenios.save)
    //     .get(app.api.cadBConvenios.getById)
    //     .delete(app.api.cadBConvenios.remove)




    //     app.route('/cad-convenios')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadBConvenios.save)
    //         .get(app.api.cadBConvenios.get)
    //     app.route('/cad-convenios/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadBConvenios.save)
    //         .get(app.api.cadBConvenios.getById)
    ...
    //     app.route('/cad-classes')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadClasses.save)
    //         .get(app.api.cadClasses.get)
    //     app.route('/cad-classes/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadClasses.save)
    //         .get(app.api.cadClasses.getById)
    //         .delete(app.api.cadClasses.remove)

    //     app.route('/cad-funcoes')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadFuncoes.save)
    //         .get(app.api.cadFuncoes.get)
    //     app.route('/cad-funcoes/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadFuncoes.save)
    //         .get(app.api.cadFuncoes.getById)
    //         .delete(app.api.cadFuncoes.remove)

    //     app.route('/cad-certidao')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadSCertidao.save)
    //         .get(app.api.cadSCertidao.get)
    //     app.route('/cad-certidao/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadSCertidao.save)
    //         .get(app.api.cadSCertidao.getById)
    //         .delete(app.api.cadSCertidao.remove)

    //     app.route('/cad-servidores')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadServidores.save)
    //         .get(app.api.cadServidores.get)
    //     app.route('/cad-servidores/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadServidores.save)
    //         .get(app.api.cadServidores.getById)
    //         .delete(app.api.cadServidores.remove)

    //     app.route('/cad-ferias')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.cadSFerias.save)
    //         .get(app.api.cadSFerias.get)
    //     app.route('/cad-ferias/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.cadSFerias.save)
    //         .get(app.api.cadSFerias.getById)
    //         .delete(app.api.cadSFerias.remove)

    //     app.route('/fin-faixas')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.finFaixas.save)
    //         .get(app.api.finFaixas.get)
    //     app.route('/fin-faixas/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.finFaixas.save)
    //         .get(app.api.finFaixas.getById)
    //         .delete(app.api.finFaixas.remove)

    //     app.route('/fin-referencias')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.finReferencias.save)
    //         .get(app.api.finReferencias.get)
    //     app.route('/fin-referencias/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.finReferencias.save)
    //         .get(app.api.finReferencias.getById)
    //         .delete(app.api.finReferencias.remove)

    //     app.route('/orgao-resp')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.orgaoResp.save)
    //         .get(app.api.orgaoResp.get)
    //     app.route('/orgao-resp/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.orgaoResp.save)
    //         .get(app.api.orgaoResp.getById)
    //         .delete(app.api.orgaoResp.remove)

    //     app.route('/orgao-ua')
    //         .all(app.config.passport.authenticate())
    //         .post(app.api.orgaoUA.save)
    //         .get(app.api.orgaoUA.get)
    //     app.route('/orgao-ua/:id')
    //         .all(app.config.passport.authenticate())
    //         .put(app.api.orgaoUA.save)
    //         .get(app.api.orgaoUA.getById)
    //         .delete(app.api.orgaoUA.remove)
    // 
}