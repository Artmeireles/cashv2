            ...
            <div class="col-12">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-4">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.cnpj" id="cnpj" type="text" maxlength="14" />
                    </div>
                    <div class="field col-12 md:col-4">
                    ...
                    <div class="field col-12 md:col-4">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.resp_remun" id="resp_remun" type="text" maxlength="1" />
                    </div>
                    <div class="field col-12 md:col-4">
