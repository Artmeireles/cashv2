...
import ServCessaoForm from './ServCessaoForm.vue';
...
const urlBase = ref(`${baseApiUrl}/serv-cessao`);
...
<template>
    <div class="card">
        <ServCessaoForm @changed="loadData" v-if="['new', 'edit'].includes(mode)" />
        <DataTable
            ref="dt"
            :value="gridData"
            :paginator="true"
            ...
            filterDisplay="menu"
            :filters="filters"
            :globalFilterFields="['id_serv_vinc', 'cnpj', 'dt_inicio']"
        ...
        >
            ...
            <Column field="cnpj" header="Motivo Afastamento" sortable>
                <template #body="{ data }">
                    {{ data.cnpj }}
                </template>
                <template #filter="{ filterModel }">
            ...
            <Column field="dt_inicio" header="Tipo Acidente" sortable>
                <template #body="{ data }">
                    {{ data.dt_inicio }}
                </template>
                <template #filter="{ filterModel }">
