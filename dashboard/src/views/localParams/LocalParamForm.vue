...
const urlBase = ref(`${baseApiUrl}/local-params`);
            ...
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-2">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.grupo" id="grupo" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="parametro">Parâmetro</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.parametro" id="parametro" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="label">Label</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.label" id="label" type="text" maxlength="6"/>
                    </div>
                </div>
