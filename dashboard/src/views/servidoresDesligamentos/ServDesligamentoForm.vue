        ...
        <form @submit.prevent="saveData">
            <div class="col-12">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-4">
                        <label for="id_par_mt_dlg">Motivo Desligamento</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_par_mt_dlg" id="id_par_mt_dlg" type="text" maxlength="10" />
                    </div>
                    <div class="field col-12 md:col-4">
                    ...
                    <div class="field col-12 md:col-4">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.ind_pagto_ap" id="ind_pagto_ap" type="text" maxlength="1" />
                    </div>
                    <div class="field col-12 md:col-4">
