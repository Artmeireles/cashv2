...
const urlBase = ref(`${baseApiUrl}/emp-resp-contato`);
            ...
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-2">
                        <label for="id_emp_resp">Empresa</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_emp_resp" id="id_emp_resp" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="tipo">Tipo</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.tipo" id="tipo" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="contato">Contato</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.contato" id="contato" type="text" maxlength="6"/>
                    </div> 
                </div>
