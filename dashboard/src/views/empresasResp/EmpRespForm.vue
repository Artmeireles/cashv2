...
const urlBase = ref(`${baseApiUrl}/emp-resp/${store.userStore.id_emp}`);
...
<template>
    <div class="grid">
        <form @submit.prevent="saveData">
            <div class="col-12">
                <h5 v-if="itemData.id_emp">Empresa {{ itemData.id_emp }}</h5>
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-2">
                        <label for="id_local_params_tipo">Tipo</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_local_params_tipo" id="id_local_params_tipo" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="nr_insc">Nº Inscrição</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nr_insc" id="nr_insc" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="crc">CRC</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.crc" id="crc" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
