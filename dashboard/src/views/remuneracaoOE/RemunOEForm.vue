...
const urlBase = ref(`${baseApiUrl}/remun-oe`);
        ...
        <form @submit.prevent="saveData">
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-4">
                        <label for="id_param_ind_mv">Indicador de Desconto</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_param_ind_mv" id="id_param_ind_mv" type="text" maxlength="10" />
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="nr_insc">Nº Inscrição</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nr_insc" id="nr_insc" type="text" maxlength="255" />
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="id_param_cod_categ">Código da Categoria</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_param_cod_categ" id="id_param_cod_categ" type="text" maxlength="10" />
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="vlr_remun_oe">Valor da Remuneração</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.vlr_remun_oe" id="vlr_remun_oe" type="text" maxlength="255" />
                    </div>
                </div>
