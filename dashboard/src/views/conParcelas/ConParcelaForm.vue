        ...
        <form @submit.prevent="saveData">
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-2">
                        <label for="id_con_contratos">Contratos</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_con_contratos" id="id_con_contratos" type="text" maxlength="6"/>
                    </div>
                    <div class="field col-12 md:col-2">
                    ...
                    <div class="field col-12 md:col-2">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.vencimento" id="vencimento" type="text" maxlength="6" />
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="situacao">Situação</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.situacao" id="situacao" type="text" maxlength="6" />
                    </div> 
                    <div class="field col-12 md:col-2">
