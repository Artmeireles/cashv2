            ...
            <div class="col-12">
                ...
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-4">
                        <label for="nr_beneficio">Nº Beneficio</label>
                    ...
                    <div class="field col-12 md:col-4">
                        <label for="cpf_inst">CPF Instituidor</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.cpf_inst" id="cpf_inst" type="text" maxlength="11" />
                    </div>
