            ...
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-2">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.ano" id="ano" type="text" maxlength="4" />
                    </div>
                    <div class="field col-12 md:col-2">
                        <label for="mes">Mês</label>
                        <Dropdown id="mes" optionLabel="label" optionValue="value" :disabled="mode == 'view'" v-model="itemData.mes" :options="dropdownMes"> </Dropdown>
                    </div>
                    <div class="field col-12 md:col-2">
                    ...
                    <div class="field col-12 md:col-2">
                        ...
                        <Dropdown id="mes_inf" optionLabel="label" optionValue="value" :disabled="mode == 'view'" v-model="itemData.mes_inf" :options="dropdownMes"> </Dropdown>
                    </div>
                    <div class="field col-12 md:col-2">
