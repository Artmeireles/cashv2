...
const urlBase = ref(`${baseApiUrl}/serv-reintegracao`);
        ...
        <form @submit.prevent="saveData">
            <div class="col-12">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-4">
                        <label for="id_par_tp_rein">Tipo da Reintegração</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_par_tp_rein" id="id_par_tp_rein" type="text" maxlength="10" />
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="nr_proc_jud">Processo Judicial</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nr_proc_jud" id="nr_proc_jud" type="text" maxlength="20" />
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="nr_lei_anistia">Nº da Anistia</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nr_lei_anistia" id="nr_lei_anistia" type="text" maxlength="13" />
                    </div>
                    <div class="field col-12 md:col-4">
