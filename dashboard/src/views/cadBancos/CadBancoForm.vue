        ...
        <form @submit.prevent="saveData">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-4">
                        <label for="febraban">Febraban</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.febraban" id="febraban" type="text"/>
                    </div>
                    ...
                    <div class="field col-12 md:col-2">
                        <label for="nomeAbrev">Nome Abrev</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nomeAbrev" id="nomeAbrev" type="text"/>
                    </div>
                </div>
