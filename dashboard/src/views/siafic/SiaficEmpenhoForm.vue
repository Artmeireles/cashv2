        ...
        <form @submit.prevent="saveData">
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-4">
                        <label for="desapropriacao_decimo">Desapropriação Décimo</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.desapropriacao_decimo" id="desapropriacao_decimo" type="text" maxlength="10"/>
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="desapropriacao_ferias">Desapropriação Férias</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.desapropriacao_ferias" id="desapropriacao_ferias" type="text" maxlength="10"/>
                    </div>
                </div>
