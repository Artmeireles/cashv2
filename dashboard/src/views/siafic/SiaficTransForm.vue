            ...
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-4">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.tipo" id="tipo" type="text" maxlength="14"/>
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="id_siafic">Siafic</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_siafic" id="id_siafic" type="text" maxlength="10"/>
                    </div>
                    <div class="field col-12 md:col-4">
                        <label for="status_transmissao">Status da Transmissão</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.status_transmissao" id="status_transmissao" type="text" maxlength="10"/>
                    </div>
                </div>
