            ...
            <div class="col-12">
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-4">
                        <label for="nr_pub">Nº da Publicação</label>
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.nr_pub" id="nr_pub" type="text" maxlength="14"/>
                    </div>
                    <div class="field col-12 md:col-4">
                    ...
                    <div class="field col-12 md:col-4">
                        ...
                        <InputText autocomplete="no" :disabled="mode == 'view'" v-model="itemData.id_param_v_pub" id="id_param_v_pub" type="text" maxlength="10"/>
                    </div>
                </div>
